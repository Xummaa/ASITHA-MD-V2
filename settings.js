...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=nm5EkRoA#Ck4aMJvaiEefcxS97HxCY2mmsJ8P9Uo9rA2ho9lMMkE' : process.env.SESSION_ID,
...
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "iroshana120@gmail.com" : process.env.SEEDER_GMAIL,
SEEDER_PASSWORD: process.env.SEEDER_PASSWORD === undefined ? "@iroshana2008" : process.env.SEEDER_PASSWORD,
